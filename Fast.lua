...
send(msg.chat_id,msg.id,"⋆ اهلا بك في صانع ميوزك سورس تلي جود\n\n⋆ المطور ➻ @BK_ZT .","html",true, false, false, true, reply_markup)
return false 
end
if text == 'صلاح' or text == '⋆ مبرمج السورس' or text == 'مطور السورس ⋆' then  
local UserId_Info = bot.searchPublicChat("BK_ZT")
...
{
{text = username, url = "https://t.me/BK_ZT"}
},
}
...
photo = "https://t.me/sertonge/6"
local T =[[
اطلق سورس ميوزك في التلي
]]
keyboard = {} 
...
{  
{text = '• صانع بوتات حمايه •', url = 't.me/MIe3_bot'},
},
}
